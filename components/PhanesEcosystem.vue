<template>
  ...
  export default {
      data(){
          return{
              cards:[
                { img:'bag.png', title:'Phanes Index Portfolio', snippet:'Phanes Index Portfolio is designed to track performance of leading ecosystem assets, creating a strategic portfolio & investing management in the ecosystem.',showAll:false},
                { img:'cloud_db.png', title:'AMM / DEX', snippet:'Utilizing Balancer.fi technology, Phanes Exchange offers a customizable foundation of liquidity on the opBNB.', showAll:false},
