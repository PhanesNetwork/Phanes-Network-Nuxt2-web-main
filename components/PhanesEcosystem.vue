<template>
  ...
  export default {
      data(){
          return{
              cards:[
                { img:'bag.png', title:'AMM / DEX', snippet:'Utilizing Balancer technology, Phanes Exchange offers a customizable foundation of decentralized liquidity pools.',showAll:false},
