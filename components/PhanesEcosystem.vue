<template>
  ...
  export default {
      data(){
          return{
              cards:[
                { img:'bag.png', title:'AMM / DEX', snippet:'Utilizing Balancer.fi technology, Phanes Exchange offers a customizable foundation of liquidity pools on opBNB.',showAll:false},
