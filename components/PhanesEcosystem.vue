<template>
  ...
  export default {
      data(){
          return{
              cards:[
                { img:'cloud_db.png', title:'Staking Programme', snippet:'Utilizing a NFT-backed staking framework, Phanes Network offers a flexible decentralized staking pools across multiple exchange, enabling users to earn reward.',showAll:false},
