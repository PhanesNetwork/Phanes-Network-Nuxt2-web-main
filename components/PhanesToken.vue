    ...
    <div class="row">
        <div class="token leftToken">
            <div class="content">
                ...
                <button class="learnMore-btn"><a href="https://v2-app.pulsex.com/swap?outputCurrency=0x833aF3Fcbd10ce8d68aBFD357A5431605d6Ea6E7" target="_blank">Buy Token</a></button>
            </div>
        </div>
